...
class cccl_resource_ref {
 public:
   ...
   */
  template <typename OtherResourceType,
            std::enable_if_t<!is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                                                     cuda::mr::synchronous_resource_ref> &&
                             !is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                                                     cuda::mr::resource_ref> &&
                             !is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                                                     ::rmm::detail::cccl_resource_ref> &&
                             !is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                                                     ::rmm::detail::cccl_async_resource_ref> &&
                             !std::is_base_of_v<rmm::mr::device_memory_resource,
                                                std::remove_cv_t<OtherResourceType>> &&
 ...
 public:
  ...
  template <
    ...
    std::enable_if_t<
      !is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                              cuda::mr::synchronous_resource_ref> &&
      !is_specialization_of_v<std::remove_cv_t<OtherResourceType>, cuda::mr::resource_ref> &&
      !is_specialization_of_v<std::remove_cv_t<OtherResourceType>, cuda::mr::any_resource> &&
      !is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                              ::rmm::detail::cccl_resource_ref> &&
      !is_specialization_of_v<std::remove_cv_t<OtherResourceType>,
                              ::rmm::detail::cccl_async_resource_ref> &&
